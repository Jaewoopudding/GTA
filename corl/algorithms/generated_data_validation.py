...
class TrainConfig:
    ...
    GDA: str = "5M-1_1x-temporalattention-50-sar"  # "gda only" 'gda with original' None
    diffusion_horizon: int = 31
    diffusion_backbone: str = 'temporal_attention' # 'mixer', 'temporal'
    
    conditioned: bool = True
    data_volume: int = 2500000
    generation_type: str = 'sar' # 's,a' 's,a,r'
    guidance_temperature: float = 1.
    guidance_target_multiple: float = 1.5
    ...
    # Wandb logging
    project: str = "augmentation_baselines_v6"
    ...
    datapath: str = None# '/home/jaewoo/practices/diffusers/Augmentation-For-OfflineRL/data/generated_data/5M-1_1x-temporalattention-50-sar.npy'
...
def train(config: TrainConfig):
    ...
    # if config.GDA:
    #     generated_dataset = get_generated_dataset(config.env, config.step)
    #     dataset = merge_dictionary([dataset, generated_dataset])

    
    # with open(f'/home/jaewoo/practices/diffusers/Augmentation-For-OfflineRL/data/generated_data/5m_samples_bf0_with_reward.npy','rb') as f:
