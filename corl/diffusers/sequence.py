...
from .d4rl_module import load_environment, sequence_dataset
...
class SequenceDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, env='hopper-medium-replay', horizon=64,
        ...
        self.observation_mean = fields['observations'].mean()
        self.observation_std = fields['observations'].std()
        self.action_mean = fields['actions'].mean()
        self.action_std = fields['actions'].std()
