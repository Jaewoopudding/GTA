...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_data_nm', type=str, default="5M-1_3x-smallmixer-50-sar-temp2_0.npz")
    ...
    data_id = f"{args.dataset}_{args.test_data_nm}_{args.percentage}"
    stats = {
        data_id: {
