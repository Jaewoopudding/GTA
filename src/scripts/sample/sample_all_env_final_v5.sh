...
# dataset1="halfcheetah-medium-expert-v2"
# ckpt1="results/halfcheetah-medium-expert-v2/smallmixer_denoiser_v4/2024-01-11/12:31/model-1000000.pt"

# dataset2="walker2d-medium-replay-v2"
# ckpt2="results/walker2d-medium-replay-v2/smallmixer_denoiser_v4/2023-12-30/19:04/model-1000000.pt"
...
# dataset4="hopper-medium-replay-v2"
# ckpt4="results/hopper-medium-replay-v2/smallmixer_denoiser_v4/2023-12-30/18:45/model-1000000.pt"
...
# bash src/scripts/sample/sample_any_env_final.sh $dataset4 3 $ckpt4 $config_name&



dataset1="halfcheetah-medium-v2"
ckpt1="results/halfcheetah-medium-v2/smallmixer_denoiser_v4/2023-12-23/model-1000000.pt"

dataset2="halfcheetah-medium-replay-v2"
ckpt2="results/halfcheetah-medium-replay-v2/smallmixer_denoiser_v4/2024-01-07/06:34/model-1000000.pt"
