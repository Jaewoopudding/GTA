...
n_episodes=100
alpha=2.5
datapath=results/maze2d-large-v1/smallmixer_denoiser_v4_maze/2024-01-26/03:10/5M-1_1x-smallmixer-50-sar-temp2_0_10.npz
...
do
    ...
    wait
    # python corl/algorithms/td3_bc.py --datapath=$datapath --data_mixture_type=$data_mixture_type --alpha=$alpha --n_episodes=$n_episodes --device=cuda:0 --s4rl_augmentation_type=$s4rl_augmentation_type --adv_scale=$adv_scale --std_scale=$std_scale --uniform_scale=$uniform_scale --env=$env --GDA_id=$GDA_id --seed= --max_timesteps=$max_timesteps --batch_size=$batch_size --buffer_size=$buffer_size &
    # python corl/algorithms/td3_bc.py --datapath=$datapath --data_mixture_type=$data_mixture_type --alpha=$alpha --n_episodes=$n_episodes --device=cuda:0 --s4rl_augmentation_type=$s4rl_augmentation_type --adv_scale=$adv_scale --std_scale=$std_scale --uniform_scale=$uniform_scale --env=$env --GDA_id=$GDA_id --seed= --max_timesteps=$max_timesteps --batch_size=$batch_size --buffer_size=$buffer_size &
    # python corl/algorithms/td3_bc.py --datapath=$datapath --data_mixture_type=$data_mixture_type --alpha=$alpha --n_episodes=$n_episodes --device=cuda:1 --s4rl_augmentation_type=$s4rl_augmentation_type --adv_scale=$adv_scale --std_scale=$std_scale --uniform_scale=$uniform_scale --env=$env --GDA_id=$GDA_id --seed= --max_timesteps=$max_timesteps --batch_size=$batch_size --buffer_size=$buffer_size &
    # python corl/algorithms/td3_bc.py --datapath=$datapath --data_mixture_type=$data_mixture_type --alpha=$alpha --n_episodes=$n_episodes --device=cuda:1 --s4rl_augmentation_type=$s4rl_augmentation_type --adv_scale=$adv_scale --std_scale=$std_scale --uniform_scale=$uniform_scale --env=$env --GDA_id=$GDA_id --seed= --max_timesteps=$max_timesteps --batch_size=$batch_size --buffer_size=$buffer_size &
    # wait
done
