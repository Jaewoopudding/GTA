...
do
    python corl/algorithms/cql.py --data_mixture_type=$data_mixture_type --n_episodes=$n_episodes --device=cuda:0 --s4rl_augmentation_type=$s4rl_augmentation_type --adv_scale=$adv_scale --std_scale=$std_scale --uniform_scale=$uniform_scale --env=$env --GDA=$GDA --seed=0 --max_timesteps=$max_timesteps --batch_size=$batch_size --buffer_size=$buffer_size &
    ...
    python corl/algorithms/cql.py --data_mixture_type=$data_mixture_type --n_episodes=$n_episodes --device=cuda:1 --s4rl_augmentation_type=$s4rl_augmentation_type --adv_scale=$adv_scale --std_scale=$std_scale --uniform_scale=$uniform_scale --env=$env --GDA=$GDA --seed=2 --max_timesteps=$max_timesteps --batch_size=$batch_size --buffer_size=$buffer_size &
